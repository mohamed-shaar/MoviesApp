...
public class VideoResult {
     ...
     * @param size
     */
    public VideoResult(String id, String iso6391, String iso31661, String key, String name, String site, long size, String type) {
        super();
        this.id = id;
    ...
    public VideoResult withIso31661(String iso31661) {
        this.iso31661 = iso31661;
        return this;
    }
    ...
    public VideoResult withSize(long size) {
        this.size = size;
        return this;
    }
